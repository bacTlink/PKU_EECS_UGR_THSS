...
\renewcommand{\theequation}{\thechapter.\arabic{equation}} %公式标签 章.公式（均为阿拉伯数字）
...
\CTEXsetup[format={\center\heiti\zihao{3}\sffamily},beforeskip=-14.4pt,afterskip=18pt]{chapter}
...
{\thesection\quad}
{0pt}
{}%1. 第一级（四号，14pt、黑体/Time new roman）

\titleformat{\subsection}
{\raggedright\fontsize{13}{13}\heiti}
{\thesubsection\quad}
{0pt}
{}%1.1 第二级（13pt，黑体/Time new roman）

\titleformat{\subsubsection}
{\raggedright\fontsize{12}{12}\heiti}
{\thesubsubsection\quad}
{0pt}
{}%1.1.1 第三级（小四，12pt，黑体/Time new roman）
